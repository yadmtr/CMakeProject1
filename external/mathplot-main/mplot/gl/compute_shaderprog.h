...
namespace mplot {
    namespace gl {
        ...
        struct compute_shaderprog
        {
             ...
             *   {GL_COMPUTE_SHADER, "my_compute_shader.glsl", mplot::defaultComputeShader }
             * };
             */
            compute_shaderprog (const std::vector<mplot::gl::ShaderInfo>& shaders)
            {
            ...
            void load_shaders (const std::vector<mplot::gl::ShaderInfo>& shaders)
            {
                this->prog_id = mplot::gl::LoadShaders (shaders);
            }
