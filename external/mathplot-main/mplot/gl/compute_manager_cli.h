...
#include <mplot/gl/compute_shaderprog.h> // A compute-shader class
...
namespace mplot {
    namespace gl {
        ...
        // file-based shader in mplot::gl::LoadShaders.
         ...
         */
        template <int glver = mplot::gl::version_4_5>
        ...
        protected:
            ...
            void init_context()
            {
                ...
                static const EGLint attribs[] = {
                    EGL_CONTEXT_MAJOR_VERSION, mplot::gl::version::major(glver),
                    EGL_CONTEXT_MINOR_VERSION, mplot::gl::version::minor(glver),
                    EGL_NONE
                };
            ...
            void init_gl()
            {
                ...
                std::cout << "compute_manager_cli<" << mplot::gl::version::vstring (glver)
        ...
        public:
            ...
            // {
            //   std::vector<mplot::gl::ShaderInfo> shaders1 = {
            //     {GL_COMPUTE_SHADER, "Default.compute1.glsl", mplot::gl::nonCompilingComputeShader, 0 }
            //   };
            //   this->my_compute_program_1.load_shaders (shaders1);
            //
            //   std::vector<mplot::gl::ShaderInfo> shaders2 = {
            //     {GL_COMPUTE_SHADER, "Default.compute2.glsl", mplot::gl::nonCompilingComputeShader, 0 }
            //   };
            //   this->my_compute_program_2.load_shaders (shaders2);
            // }
            //
            // Here "Default.compute.glsl" is the path to a file containing the GLSL
            // code. mplot::defaultComputeShader is a const char* of some default GLSL code
