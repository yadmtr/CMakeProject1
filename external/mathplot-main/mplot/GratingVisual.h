    ...
    public:
        ...
        void initializeVertices()
        {
            ...
            (unsigned int i, const sm::vec<float, 2>& p_step)
            {
                ...
                for (sm::vec<float, 2> p = p_0; ; p += p_step) {
                    ...
                    if constexpr (debug_geometry) {
                        col = i%2==0 ? mplot::colour::green2 : mplot::colour::blue2;
                        band_repl_col = (i%2==0 ? mplot::colour::palegreen : mplot::colour::lightblue1);
                        band_compl_col1 = (i%2==0 ? mplot::colour::lightgreen : mplot::colour::lightblue2);
                        band_compl_col2 = (i%2==0 ? mplot::colour::palegreen3 : mplot::colour::lightblue3);
                    }
                    ...
                    if constexpr (debug_geometry) {
                        this->computeSphere (p_0.plus_one_dim(), mplot::colour::crimson, 0.012f, 16, 20);
                        this->computeSphere (p1.plus_one_dim(), mplot::colour::grey20, 0.02f, 16, 20);
                        this->computeSphere (q1.plus_one_dim(), mplot::colour::grey20, 0.02f, 16, 20);
                        this->computeSphere (p2.plus_one_dim(), mplot::colour::navy, 0.02f, 16, 20);
                        this->computeSphere (q2.plus_one_dim(), mplot::colour::navy, 0.02f, 16, 20);
                    }
                    ...
                    if (first_off && second_off && first_loop) {
                        ...
                        if constexpr (debug_geometry) {
                            this->computeSphere (fp1.plus_one_dim(), mplot::colour::crimson, 0.01f, 16, 20);
                            this->computeSphere (fq1.plus_one_dim(), mplot::colour::violetred2, 0.01f, 16, 20);
                            this->computeSphere (fp2.plus_one_dim(), mplot::colour::royalblue, 0.01f, 16, 20);
                            this->computeSphere (fq2.plus_one_dim(), mplot::colour::dodgerblue1, 0.01f, 16, 20);
                        }
                    }
                    i++;
                }
            ...
            if constexpr (debug_geometry) {
                ...
                this->computeArrow (vfstart, vfstart + this->v_front.plus_one_dim(), mplot::colour::black);
        ...
        std::array<float, 3> colour1 = mplot::colour::white;
        std::array<float, 3> colour2 = mplot::colour::black;
